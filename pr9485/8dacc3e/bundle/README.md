...
`8dacc3e19b9ca8df59aab4bf17fc5d4a1fcbb975`.
...
test "$(git rev-parse HEAD)" = "8dacc3e19b9ca8df59aab4bf17fc5d4a1fcbb975"
...
Expected: `test_compose_commands.py` passes 1/1; the sync dry run emits no
line beginning with `linked` or `error:`. The published collection log also
records the 17/17 canonical byte comparisons, four retained Gemini wrapper
mappings, two global Codex pointers, and clean pre/post SHA identity. Those
...
- [`terminal.gif`](https://jleechan2015.github.io/worldarchitect-pr-evidence/pr9485/8dacc3e/terminal.gif) — browser-friendly preview of provenance, diff, tests, sync, byte-preservation, discovery, and post-run SHA.
- [`terminal.mp4`](https://jleechan2015.github.io/worldarchitect-pr-evidence/pr9485/8dacc3e/terminal.mp4) — downloadable high-fidelity terminal video, served as `video/mp4`.
- [`terminal.vtt`](https://jleechan2015.github.io/worldarchitect-pr-evidence/pr9485/8dacc3e/terminal.vtt) — captions naming the test, result, and key assertions, served as `text/vtt`.
